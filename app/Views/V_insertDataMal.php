...
<div class="container">		
<br></br>
<h1>Halaman Data Baru Muzakki Zakat Mal</h1>

<p>Masukkan Data Dengan Benar</p>
    
    <form action="<?php echo base_url('Datamal/saveDataMal')?>" method="post" form class="pure-form pure-form-aligned">
    ...
    <fieldset>
        ...
        <div class="pure-control-group">
            ...
            <input type="text" id="jml_hasil" name="jml_hasil" onkeyup="hitungPersen()" placeholder="" />
        </div>
            <div class="pure-control-group">
