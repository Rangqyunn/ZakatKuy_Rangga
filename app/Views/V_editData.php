...
?>
<br></br>
<h1>Halaman Edit Data Muzakki Zakat Fitrah</h1>

<p>Masukkan Data Dengan Benar</p>
<form action="<?php echo base_url('Data/saveEditData/' .$row->nik.'')?>" method="post" form class="pure-form pure-form-aligned">
    <fieldset>
        <div class="pure-control-group">
            <label for="nik">NIK</label>
            <input type="text" id="nik"name="nik" placeholder="" onblur="cekPanjang()" maxlength="16" value="<?php echo $row->nik;?>"/>
        ...
        <div class="pure-control-group">
                ...
                <select id="jns_zakat" name="jns_zakat" onchange="updateZakat()" class="pure-input-u-1-4" value="<?php echo $row->jns_zakat;?>">
