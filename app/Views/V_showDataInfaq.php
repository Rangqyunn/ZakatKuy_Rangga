...
//?>
<br></br>
<h1>Halaman Data Infaq Masjid</h1>
<p>Data Muzakki Berupa Nama, Alamat, Tanggal dan Jumlah Infaq</p>
...
<td></td>
        ...
        <tr>
            ...
            <td>TANGGAL</td>
            <td>JUMLAH INFAQ</td>
            <td>AKSI <a href='/ReportInfaq/tampilPdfInfaq' button type="button" class="btn btn-link" data-mdb-ripple-color="dark">Report PDF</button></td>
        </tr>
        </thead>
        <?php
        ...
        <tr>
            ...
            <td> 
                <a href="datainfaq/editDataInfaq/<?php echo $row->nik; ?>" class="btn btn-rounded" style="background-color: #90CAF9;">Edit</a>
                <a href="datainfaq/hapusDataInfaq/<?php echo $row->nik; ?>" class="btn btn-rounded" style="background-color: #F06292">Hapus</a>
            </td>
        </tr>
        <?php
        }
