...
<div class="container">		
<br></br>
<h1>Halaman Data Baru Infaq Masjid</h1>

<p>Masukkan Data Dengan Benar</p>
    
    <form action="<?php echo base_url('Datainfaq/saveDataInfaq')?>" method="post" form class="pure-form pure-form-aligned">
    ...
    <div class="pure-control-group">
        ...
        <div class="pure-control-group">
            ...
            <input type="text" id="jml_infaq" name="jml_infaq"  placeholder="" />
        </div>
